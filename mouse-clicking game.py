...
def drawRocket():
    ...
    rocketBase = screen.create_rectangle(xRocket, yRocket, xRocket+50, yRocket+100, fill="blue", outline="yellow" )
...
# start the game 500 milliseconds after pushing F5 by calling the procedure named startRocketProgram().
root.after(500, startRocketProgram)
# makes the procedure named mouseClickHandler() get called every time the user clicks the left mouse button.
